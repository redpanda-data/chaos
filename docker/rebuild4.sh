...
mkdir -m 777 -p ./docker/bind_mounts/$COMPOSE_PROJECT_NAME-client1/mnt/vectorized/workloads/logs
mkdir -m 777 -p ./docker/bind_mounts/$COMPOSE_PROJECT_NAME-client1/mnt/vectorized/entrypoint
