...
from chaos.workloads.tx_subscribe import consistency
from chaos.workloads.tx_subscribe import stat
...
class Workload:
    ...
    def init(self, idx, node, server, brokers, source, partitions, target, group_id, experiment, settings, timeout_s=10):
        ip = node.ip
