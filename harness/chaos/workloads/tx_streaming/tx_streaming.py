...
from chaos.workloads.tx_streaming import consistency
from chaos.workloads.tx_streaming import stat
...
class Workload:
    ...
    def init(self, node, server, brokers, source, target, group_id, experiment, settings):
        ip = node.ip
