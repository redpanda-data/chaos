...
from chaos.workloads.rw_subscribe import consistency
from chaos.workloads.rw_subscribe import stat
...
class Workload:
    ...
    def wait_progress(self, timeout_s=10):
        ...
        # rw_subscribe requires at least one client to make progress
    ...
    def init(self, node, server, brokers, topic, partitions, group_id, experiment, settings, timeout_s=10):
        ip = node.ip
