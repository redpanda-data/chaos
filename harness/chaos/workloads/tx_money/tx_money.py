...
from chaos.workloads.tx_money import consistency
from chaos.workloads.tx_money import stat
...
class Workload:
    ...
    def init(self, node, server, brokers, accounts, experiment, settings):
        ip = node.ip
