...
from chaos.workloads.tx_poll import consistency
from chaos.workloads.tx_poll import stat
...
class Workload:
    ...
    def init(self, node, server, brokers, experiment, settings, timeout_s=10):
        ip = node.ip
